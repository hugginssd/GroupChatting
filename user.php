...
<body class="cbp-spmenu-push">
  ...
  <form action="upload.php" method="post" enctype="multipart/form-data">
    ...
    <input type="submit" value="Upload File" name="submit" class="btn1">
</form>
<?php
...
$a='...';
   echo'<a href="uploads/'.$file.' "target="_blank"> '.substr($file,0,15).$a.substr($file,-3).'</a>';
}
}
?>
      </nav>
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="#" target="">Design and Developed by Maria</a></p>		
	</div>
    <!--//footer-->
	</div>
